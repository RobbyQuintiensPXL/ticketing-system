insert into jevent_event_dev.events (id, description, event_date, event_name, event_type, short_description, location_id, event_time)
...
insert into jevent_event_dev.locations (id, address, building_name, city, country, zip_code, ticket_office_id)
...
insert into jevent_event_dev.ticket_offices (id, organisation)
values  (1, 'Test');